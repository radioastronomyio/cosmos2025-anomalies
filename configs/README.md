...
| File | Description |
|------|-------------|
| `data_paths.yaml` | Master config. Defines catalog and semantic evidence paths, dictionary and staging outputs, database connection parameter names, and supplementary file locations |
